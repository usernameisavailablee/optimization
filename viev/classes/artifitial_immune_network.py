...
from modules.artificial_immune import *
from modules.functions import choise_function
class SubWindowArtifitialImmuneNetwork(SubWindow):
    ...
    #    best_individual, best_individual_history,all_generations  = genetic_algorithm(pop_size=100, genome_length=3, generations=10,self.func)
        ff = self.func
        all_generations= algorithm_artificial_immune_system(x_min, x_max, x_step, y_min, y_max, y_step, pop_size, generations,ff)
